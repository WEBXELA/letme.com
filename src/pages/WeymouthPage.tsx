      ...
      <main>
        ...
        <section className="hidden md:block bg-gradient-to-br from-primary to-[hsl(var(--hero-gradient-to))] text-primary-foreground py-10 md:py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center space-y-4 animate-fade-in">
              <h1 className="font-heading text-3xl md:text-5xl lg:text-6xl font-bold">Weymouth</h1>
              <p className="text-sm md:text-xl text-primary-foreground/90">Explore our properties in the beautiful seaside town of Weymouth</p>
            </div>
          </div>
        </section>
        ...
        <div className="md:hidden border-y border-black bg-black sticky top-[64px] z-30">
          <div className="container mx-auto px-4 py-2 text-sm text-white">
            ...
            <span className="font-medium">Weymouth</span>
          </div>
        </div>
